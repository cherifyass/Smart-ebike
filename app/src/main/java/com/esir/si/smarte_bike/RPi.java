...
public class RPi extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button verouiller = (Button) findViewById(R.id.verouiller);
        final Button deverouiller = (Button) findViewById(R.id.deverouiller);
        ...
        deverouiller.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                // Perform action on temp button click

                (new Thread(new workerThread("deverouiller"))).start();
        ...
        verouiller.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                (new Thread(new workerThread("verouiller"))).start();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_rpi, menu);
        return true;
    }
